...
extension String {
  ...
  */
  ...
  subscript(r: OpenEndedRange<String.Index>) -> String {
    return self.substringFromIndex(r.start)
  }
  subscript(r: OpenStartedRange<String.Index>) -> String {
    return self.substringFromIndex(r.end)
  }
